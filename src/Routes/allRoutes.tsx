...
const authProtectedRoutes = [
    ...
    // Teams
    // { path: "/teams-member-list", component: <TeamMembers /> },
    // { path: "/teams-member-add", component: <CreateTeamMember /> },

    // About
    // { path: "/about-dashboard", component: <AboutDashboard /> },

    // Testimonials
    // { path: "/testimonials-list", component: <TestimonialsDashboard /> },
    // { path: "/create-testimonial", component: <CreateTestimonials /> },

    // Banner
    // { path: "/banner-list", component: <BannerList /> },
    // { path: "/create-banner", component: <CreateBanner /> },

    // Clients & Families
    // {path: "/projects-and-families", component: <ClientsAndFamilies />},
    ...
    // { path: "*", component: <Navigate to="/products-list" /> },
